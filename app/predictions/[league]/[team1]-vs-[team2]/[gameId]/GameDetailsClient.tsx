...
export default function GameDetailsClient({ initialGame, gameId }: { initialGame: EvaluatedGame, gameId: string }) {
  const [game, setGame] = useState<EvaluatedGame>(initialGame);
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const response = await sendMessage(gameId, message);
          ...
          <div className="lg:w-2/3">
            <div className="bg-white shadow-lg rounded-lg p-6 mb-8">
              <h2 className="text-2xl font-semibold mb-4 text-black">
                Game Analysis and Betting Tips
              </h2>
            ...
            {/* Chat section */}
            {user && <div className="bg-white shadow-lg rounded-lg p-6">
            ...
            <div className="bg-white shadow-lg rounded-lg p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-black">Probable Pitcher: {game.data.boxScore.away?.probable_pitcher.full_name || "TBA"}</p>
                ...
                <div>
                  ...
                  <p className="text-black">Probable Pitcher: {game.data.boxScore.home?.probable_pitcher?.full_name || "TBA"}</p>
